...
export class Migration20230803230928 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "refresh_token" ("id" serial primary key, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) null, "updated_at" timestamptz(0) null, "expires_in" timestamptz(0) not null, "user_id" int not null, "is_active" boolean not null default true);',
    );
